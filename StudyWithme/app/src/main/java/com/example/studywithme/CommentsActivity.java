...
import com.example.studywithme.adapter.CommentsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.iv_comment_back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(CommentsActivity.this, CalendarFragment.class);
                            ...
                            mStore.collection(FirebaseID.post).document(board_collectionID)
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            ...
                                            Intent intent = new Intent(CommentsActivity.this, CalendarFragment.class);
